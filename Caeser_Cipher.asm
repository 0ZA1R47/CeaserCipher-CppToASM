...
Menu:													 ; Menu Label
	...
	CALL readdec										 ; Reading decimal from console
	MOV Key,AX											 ; Moving the contents of AX to Key
...
Encryption proc											 ; Encryption Procedure
	...
	l2:													 ; l2 Label
		MOV EAX,0										 ; Clearing the contents of EAX
		cmp buffer[ESI], 65								 ; Comparing lowercase 'a' with AL (Using ASCII)
		...
		cmp buffer[ESI], 97                              ; Comparing uppercase 'A' with AL (Using ASCII)
